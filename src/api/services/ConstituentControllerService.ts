...
/* tslint:disable */
/* eslint-disable */
import type { AddConstituentDto } from "../dto/AddConstituentDto";
import type { AddEthnicGroupToConstituentDto } from "../dto/AddEthnicGroupToConstituentDto";
import type { ConstituentDto } from "../dto/ConstituentDto";
import type { DeleteEthnicGroupToConstituentDto } from "../dto/DeleteEthnicGroupToConstituentDto";
import type { EditConstituentDto } from "../dto/EditConstituentDto";
import type { EthnicGroupToConstituentDto } from "../dto/EthnicGroupToConstituentDto";
...
export class ConstituentControllerService {
   ...
   * @throws ApiError
   */
  public static constituentsControllerGetConstituents(): CancelablePromise<
    Array<ConstituentDto>
  > {
    return __request(OpenAPI, {
      method: "GET",
