...
/* tslint:disable */
/* eslint-disable */
import type { AddEthnicGroupMapDto } from "../dto/AddEthnicGroupMapDto";
import type { ConstituentFilledDto } from "../dto/ConstituentFilledDto";
import type { EthnicGroupMapDto } from "../dto/EthnicGroupMapDto";
import type { EthnicGroupMapPointEntity } from "../dto/EthnicGroupMapPointEntity";
import type { EthnicGroupMapPointEntityWithConstituents } from "../dto/EthnicGroupMapPointEntityWithConstituents";
import type { EthnicGroupMapWithGroupDto } from "../dto/EthnicGroupMapWithGroupDto";
import type { StreamableFile } from "../dto/StreamableFile";
...
export class MapControllerService {
   ...
   * @throws ApiError
   */
  public static mapControllerGetMapTopojson(): CancelablePromise<
    StreamableFile
  > {
   ...
   * @throws ApiError
   */
  public static mapControllerGetEthnicalGroupPoints(): CancelablePromise<
    Array<EthnicGroupMapWithGroupDto>
  > {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static mapControllerGetPercentsFilledStoriesByConstituentId(): CancelablePromise<
    Array<ConstituentFilledDto>
  > {
    return __request(OpenAPI, {
      method: "GET",
