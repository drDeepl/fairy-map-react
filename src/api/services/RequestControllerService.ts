...
/* tslint:disable */
/* eslint-disable */
import type { AddTypeRequestDto } from "../dto/AddTypeRequestDto";
import type { EditTypeRequestDto } from "../dto/EditTypeRequestDto";
import type { TypeRequestDto } from "../dto/TypeRequestDto";
...
export class RequestControllerService {
   ...
   * @throws ApiError
   */
  public static requestControllerGetAllRequestTypes(): CancelablePromise<
    Array<TypeRequestDto>
  > {
   ...
   * @throws ApiError
   */
  public static requestControllerGetRequestStatuses(): CancelablePromise<
    Array<string>
  > {
    return __request(OpenAPI, {
      method: "GET",
