...
/* tslint:disable */
/* eslint-disable */
import type { AddEthnicGroupDto } from "../dto/AddEthnicGroupDto";
import type { AddLanguageDto } from "../dto/AddLanguageDto";
import type { EditEthnicGroupDto } from "../dto/EditEthnicGroupDto";
import type { EthnicGroupDto } from "../dto/EthnicGroupDto";
import type { EthnicGroupLanguageDto } from "../dto/EthnicGroupLanguageDto";
...
export class EthnicGroupControllerService {
   ...
   * @throws ApiError
   */
  public static ethnicGroupControllerEthnicGroups(): CancelablePromise<
    Array<EthnicGroupLanguageDto>
  > {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static ethnicGroupControllerGetAllLanguage(): CancelablePromise<
    Array<LanguageDto>
  > {
    return __request(OpenAPI, {
      method: "GET",
